      ...
      <main id="content" class="site-main">
         <section class="inner-page-wrap">
            ...
            <div class="inner-banner-wrap">
               <div class="inner-baner-container" style="background-image: url(assets/images/back.jpg);" width="100%" height="50%">
                  <div class="container">
                     ...
                     <div class="col-lg-8">
                        ...
                        <div class="client-slider white-bg">
                           <figure class="client-item">
                              <img src="assets/images/himal.jpg" alt="">
                           </figure>
                           <figure class="client-item">
                     ...
                     <div class="col-lg-8 offset-lg-2 text-center">
                        <div class="callback-content">
                           <div class="video-button">
                              <a id="video-container" data-fancybox="video-gallery" href="https://youtu.be/bY_gRApfoJk?si=f04UcFW0K1FKjJah">
