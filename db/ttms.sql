...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2024 at 05:42 PM
...
(1, 'Kathmandu Cultural Tour', 'Cultural', 'Kathmandu', 12000, 'Sightseeing, Heritage, Temples', 'Explore the rich cultural heritage of Kathmandu, including visits to UNESCO World Heritage sites like Basantapur Durbar Square, Pashupatinath, and Swayambhunath (Monkey Temple).', 'kathmandu_tour.jpg', '2024-09-26 14:00:48', NULL),
(2, 'Pokhara Adventure Package', 'Adventure', 'Pokhara', 15000, 'Boating, Paragliding, Trekking', 'A thrilling adventure in Pokhara, where you can enjoy paragliding, boating in Phewa Lake, and hiking to Sarangkot for a breathtaking sunrise view.', 'pokhara_adventure.jpg', '2024-09-26 14:00:48', NULL),
...
(4, 'Lumbini Pilgrimage Tour', 'Pilgrimage', 'Lumbini', 10000, 'Buddhist Pilgrimage, Meditation, Museum Visit', 'Visit the birthplace of Lord Buddha in Lumbini, a UNESCO World Heritage Site, and explore the Lumbini Museum, monasteries, and meditation centers.', 'lumbini_tour.jpg', '2024-09-26 14:00:48', NULL),
(5, 'Nagarkot Hill Station Getaway', 'Leisure', 'Nagarkot', 8000, 'Sunrise View, Relaxation, Short Hiking', 'A perfect getaway to Nagarkot to enjoy the stunning sunrise view of the Himalayas, including Mount Everest, and short hikes around the tranquil hill station.', 'nagarkot_getaway.jpg', '2024-09-26 14:00:48', NULL),
(6, 'Boudhanath Stupa Meditation Package', 'Spiritual', 'Boudhanath', 9000, 'Meditation, Cultural Exploration', 'Immerse yourself in spiritual peace with a meditation retreat at Boudhanath Stupa, one of the largest stupas in Nepal, surrounded by Tibetan monasteries.', 'boudhanath_meditation.jpg', '2024-09-26 14:00:48', NULL),
(7, 'Begnas Lake Retreat', 'Leisure', 'Begnas Lake', 11000, 'Boating, Fishing, Relaxation', 'A relaxing retreat by the serene Begnas Lake, offering boating, fishing, and peaceful surroundings far from the hustle and bustle of city life.', 'begnas_retreat.jpg', '2024-09-26 14:00:48', NULL),
(8, 'Patan Heritage Walk', 'Cultural', 'Patan', 7000, 'Heritage Walk, Temples, Museums', 'Discover the ancient city of Patan, known for its rich history, art, and architecture. Visit Patan Durbar Square, the Golden Temple, and local museums.', 'patan_walk.jpg', '2024-09-26 14:00:48', NULL),
(9, 'Sarangkot Paragliding Experience', 'Adventure', 'Sarangkot', 13000, 'Paragliding, Sunrise View, Trekking', 'Soar high above Pokhara valley with a paragliding experience from Sarangkot. Also, enjoy trekking and a beautiful sunrise over the Himalayas.', 'sarangkot_paragliding.jpg', '2024-09-26 14:00:48', NULL),
(10, 'Swoyambhunath Cultural Day Trip', 'Cultural', 'Swoyambhunath', 6000, 'Heritage, Pilgrimage, City View', 'A day trip to Swoyambhunath (Monkey Temple), offering panoramic views of Kathmandu city and a deep dive into the Buddhist culture and history.', 'swoyambhunath_daytrip.jpg', '2024-09-26 14:00:48', NULL);
