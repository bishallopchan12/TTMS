...
if (isset($_POST['submit'])) {
   ...
   if ($conn->query($sql) === TRUE) {
      ...
      if ($lastInsertId) {
         // Send email to user
         $to = $bemail;
         $subject = "Booking Confirmation for Package ID: $pid";
         $message = "
         <html>
         <head>
         ...
         <body>
         <p>Dear $bname,</p>
         <p>Thank you for booking with us! Your booking for Package ID: $pid is confirmed.</p>
         <p>Booking Details:</p>
         <ul>
            <li>Full Name: $bname</li>
            <li>Email: $bemail</li>
            <li>Mobile: $bmobile</li>
            <li>Place: $bcountry</li>
            <li>City: $bcity</li>
         </ul>
         ...
         // Additional headers
         $headers .= 'From: bshallama16"gmail.com' . "\r\n";
         ...
         // Success message
         echo "<script>
                alert('Booking Successful 😊. A confirmation email has been sent to $bemail');
                              ...
                              <div class="booking-content">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12">
                                       <div class="form-group">
                                       <label>Place*</label>
                                       <input type="text" name="place" id="country" placeholder="Enter the name of the place" required>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
