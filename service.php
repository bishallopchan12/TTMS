   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         <section class="service-inner-page inner-page-wrap">
            <!-- ***Inner Banner html start from here*** -->
            ...
            <!-- ***about section html start from here*** -->
            <div class="inner-service-wrap">
               <div class="container">
                  <div class="row">
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/hotel.jpg);">
                           <div class="box-icon">
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/insurance.jpg);">
                           <div class="box-icon">
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/accessible.jpg);">
                           <div class="box-icon">
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/book.jpg);">
                           <div class="box-icon">
                     ...
                     <div class="col-lg-4 col-sm-6">
                        <div class="icon-box bg-img-box" style="background-image: url(assets/images/tour.jpg);">
                           <div class="box-icon">
            ...
            <!-- ***callback section html start here*** -->
