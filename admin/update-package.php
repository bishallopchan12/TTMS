...
<html>
<head>
<title>B&B Tours And Travels Pvt. Ltd. | Admin Package Update</title>
...
<div class="col-sm-8">
<img src="Packageimages/<?php echo htmlentities($result->PackageImage);?>" width="200">&nbsp;&nbsp;&nbsp;<a href="change-image.php?imgid=<?php echo htmlentities($result->PackageId);?>">Change Image</a>
</div>
</div>
