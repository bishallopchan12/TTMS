<footer id="colophon" class="site-footer footer-primary">
                        ...
                        <div class="col-lg-6">
                           <div class="footer-newsletter">
                              ...
                              <form class="newsletter">
                                 ...
                                 <button type="submit" class="outline-btn outline-btn-blue">Subscribe</button>
                              </form>
                           </div>
                        </div>
            ...
            <div class="bottom-footer">
               <div class="container">
                  <div class="copy-right text-center">Copyright &copy; 2024 B&B Travels and Tour Pvt. Ltd. All rights reserved.</div>
               </div>
            </div>
         </footer>
